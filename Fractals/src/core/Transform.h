...
//	typedef Eigen::Matrix<real, Dim, Dim> Matrixnr;
//
//public:
//	Transform(void);
//	Transform(real* values);
//	Transform(const Matrixnr& transform);
//	Transform(const Matrixnr& transform, const Matrixnr& invTransform);
//	~Transform(void);
//
//	template<class T>
//	inline T transform(const T &point);
//
//	template<class T>
...
//
//	inline Transform<Dim> inv() { return Transform<Dim>(myInvMatrix, myMatrix); }
//
//	inline Transform<Dim> operator * (const Transform<Dim>& t);
//	inline Transform<Dim>& operator *= (const Transform<Dim>& t);
//
//	static Transform<Dim> identity() { return Transform<Dim>(Matrix4r::Identity(), Matrix4r::Identity()); }
//
//	///////////////////////////////////////////////////////////////////////////////
